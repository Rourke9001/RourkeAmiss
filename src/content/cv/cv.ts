  ...
  roles: [
    {
      ...
      bullets: [
        ...
        'Root-caused a 177-second cold type-check to a single MUI SxProps spread pattern using tsc --generateTrace. Fixing 14 sites across 8 files cut it to 36.6s (−79%), halved peak memory (5.67 → 3.07 GB) and dropped the build\'s heap requirement from 16 GB to 4 GB.',
